...
<img src="/images/Front%20Office%20Workflows/Utilities/eob-creation-and-portal-checks/eob-creation-and-portal-checks-1.png" alt="" />
...
<img src="/images/Front%20Office%20Workflows/Utilities/eob-creation-and-portal-checks/eob-creation-and-portal-checks-2.png" alt="" />
...
<img src="/images/Front%20Office%20Workflows/Utilities/eob-creation-and-portal-checks/eob-creation-and-portal-checks-3.png" alt="" />

You can also click the ‘**Actions**’ menu to either view or delete a file.

<img src="/images/Front%20Office%20Workflows/Utilities/eob-creation-and-portal-checks/eob-creation-and-portal-checks-4.png" alt="" />

### 2. Upload an EOB File or Screenshot

Assuming you’re starting from scratch, click the ‘Post a New EOB’ button to get started.

<img src="/images/Front%20Office%20Workflows/Utilities/eob-creation-and-portal-checks/eob-creation-and-portal-checks-5.png" alt="" />

Select the **type of EOB** you’ll be importing. **Upload the file** and then click ‘**Continue**.’

<img src="/images/Front%20Office%20Workflows/Utilities/eob-creation-and-portal-checks/eob-creation-and-portal-checks-6.png" alt="" />
...
<img src="/images/Front%20Office%20Workflows/Utilities/eob-creation-and-portal-checks/eob-creation-and-portal-checks-7.png" alt="" />

Repeat this process until you’ve added all the claims you want, then click ‘**Process EOBs**.’

<img src="/images/Front%20Office%20Workflows/Utilities/eob-creation-and-portal-checks/eob-creation-and-portal-checks-8.png" alt="" />
...
<img src="/images/Front%20Office%20Workflows/Utilities/eob-creation-and-portal-checks/eob-creation-and-portal-checks-9.png" alt="" />
...
<img src="/images/Front%20Office%20Workflows/Utilities/eob-creation-and-portal-checks/eob-creation-and-portal-checks-10.png" alt="" />
...
<img src="/images/Front%20Office%20Workflows/Utilities/eob-creation-and-portal-checks/eob-creation-and-portal-checks-11.png" alt="" />

Clicking the button will **add a new row** to your EOB to hold the custom adjustment:

<img src="/images/Front%20Office%20Workflows/Utilities/eob-creation-and-portal-checks/eob-creation-and-portal-checks-12.png" alt="" />
...
<img src="/images/Front%20Office%20Workflows/Utilities/eob-creation-and-portal-checks/eob-creation-and-portal-checks-13.png" alt="" />
...
<img src="/images/Front%20Office%20Workflows/Utilities/eob-creation-and-portal-checks/eob-creation-and-portal-checks-14.png" alt="" />
...
<img src="/images/Front%20Office%20Workflows/Utilities/eob-creation-and-portal-checks/eob-creation-and-portal-checks-15.png" alt="" />
...
<img src="/images/Front%20Office%20Workflows/Utilities/eob-creation-and-portal-checks/eob-creation-and-portal-checks-16.png" alt="" />
...
<img src="/images/Front%20Office%20Workflows/Utilities/eob-creation-and-portal-checks/eob-creation-and-portal-checks-17.png" alt="" />
...
<img src="/images/Front%20Office%20Workflows/Utilities/eob-creation-and-portal-checks/eob-creation-and-portal-checks-18.png" alt="" />
...
<!-- HTML preserved: <blockquote> -->**Am I required to upload a file for my EOB?**

<!-- HTML preserved: </blockquote> -->No, uploading a file or screenshot is optional (but it’s strongly encouraged for record keeping).

<!-- HTML preserved: <blockquote> -->**What types of remittances can I upload?**

<!-- HTML preserved: </blockquote> -->You can upload an `EOB`, data from a `Payer Portal` check, or info from `Calling a Payer`.

<!-- HTML preserved: <blockquote> -->**Should I use this tool to upload EOBs I want Athelas to process?**

<!-- HTML preserved: </blockquote> -->Yes! EOBs intended for processing by the Athelas team should be bulk upload via this tool, which is monitored by the Athelas remittance team.