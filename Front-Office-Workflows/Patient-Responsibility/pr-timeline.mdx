...
<img src="/images/Front-Office-Workflows/Patient-Responsibility/pr-timeline/pr-timeline-1.png" alt="" />
...
<img src="/images/Front-Office-Workflows/Patient-Responsibility/pr-timeline/pr-timeline-2.png" alt="" />

From there, find the **Timeline tab** partway down the page, and the timeline will appear!

<img src="/images/Front-Office-Workflows/Patient-Responsibility/pr-timeline/pr-timeline-3.png" alt="" />
...
<img src="/images/Front-Office-Workflows/Patient-Responsibility/pr-timeline/pr-timeline-4.png" alt="" />

### Date and Time

Each card begins with the date and time that the event occurred.

<img src="/images/Front-Office-Workflows/Patient-Responsibility/pr-timeline/pr-timeline-5.png" alt="" />
...
<img src="/images/Front-Office-Workflows/Patient-Responsibility/pr-timeline/pr-timeline-6.png" alt="" />
...
<img src="/images/Front-Office-Workflows/Patient-Responsibility/pr-timeline/pr-timeline-7.png" alt="" />
...
<img src="/images/Front-Office-Workflows/Patient-Responsibility/pr-timeline/pr-timeline-8.png" alt="" />
...
<img src="/images/Front-Office-Workflows/Patient-Responsibility/pr-timeline/pr-timeline-9.png" alt="" />
...
<img src="/images/Front-Office-Workflows/Patient-Responsibility/pr-timeline/pr-timeline-10.png" alt="" />
...
<img src="/images/Front-Office-Workflows/Patient-Responsibility/pr-timeline/pr-timeline-11.png" alt="" />

The next day (Jan 12th) Athelas submitted the claim to the payer…

<img src="/images/Front-Office-Workflows/Patient-Responsibility/pr-timeline/pr-timeline-12.png" alt="" />

But then a surprise: on Feb 1st — 20 days after initial claim submission —an update is needed and the claim is resubmitted.

<img src="/images/Front-Office-Workflows/Patient-Responsibility/pr-timeline/pr-timeline-13.png" alt="" />
...
<img src="/images/Front-Office-Workflows/Patient-Responsibility/pr-timeline/pr-timeline-14.png" alt="" />
...
<img src="/images/Front-Office-Workflows/Patient-Responsibility/pr-timeline/pr-timeline-15.png" alt="" />
...
<img src="/images/Front-Office-Workflows/Patient-Responsibility/pr-timeline/pr-timeline-16.png" alt="" />
...
<img src="/images/Front-Office-Workflows/Patient-Responsibility/pr-timeline/pr-timeline-17.png" alt="" />

**Patient Statement Sent** When statements are delivered, you’ll see that in the timeline as well.

<img src="/images/Front-Office-Workflows/Patient-Responsibility/pr-timeline/pr-timeline-18.png" alt="" />
...
<img src="/images/Front-Office-Workflows/Patient-Responsibility/pr-timeline/pr-timeline-19.png" alt="" />

**Write Offs**

Whenever PR is written off, that will be indicated in the timeline.

<img src="/images/Front-Office-Workflows/Patient-Responsibility/pr-timeline/pr-timeline-20.png" alt="" />
