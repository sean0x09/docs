...
<img src="/images/Front-Office-Workflows/Posting/how-to-write-off-a-balance/how-to-write-off-a-balance-1.png" alt="" />
- Enter a reason for the write off **and specify the amount to write off for each PR CARC**. Then click **Write Off PR.**

<img src="/images/Front-Office-Workflows/Posting/how-to-write-off-a-balance/how-to-write-off-a-balance-2.png" alt="" />

- A **yellow preview row** will appear showing the write off and its impact on balances.

<img src="/images/Front-Office-Workflows/Posting/how-to-write-off-a-balance/how-to-write-off-a-balance-3.png" alt="" />
...
<img src="/images/Front-Office-Workflows/Posting/how-to-write-off-a-balance/how-to-write-off-a-balance-4.png" alt="" />
- To permanently apply the write off to the ledger, click **Post**.

<img src="/images/Front-Office-Workflows/Posting/how-to-write-off-a-balance/how-to-write-off-a-balance-5.png" alt="" />
**Notes:**
