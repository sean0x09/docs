...
<img src="/images/Billing-Workflows/Front-Office-Payments/how-to-create-suggested-pr-rules/how-to-create-suggested-pr-rules-1.png" alt="" />
...
<img src="/images/Billing-Workflows/Front-Office-Payments/how-to-create-suggested-pr-rules/how-to-create-suggested-pr-rules-2.png" alt="" />

In the Actions block, choose to `Set Copay Amount in USD Cents` and enter 1000, to equal $10.

<img src="/images/Billing-Workflows/Front-Office-Payments/how-to-create-suggested-pr-rules/how-to-create-suggested-pr-rules-3.png" alt="" />

Then, click `Add Action` and select ‘Prioritize Family Deductible’ from the new dropdown menu.

<img src="/images/Billing-Workflows/Front-Office-Payments/how-to-create-suggested-pr-rules/how-to-create-suggested-pr-rules-4.png" alt="" />
...
<img src="/images/Billing-Workflows/Front-Office-Payments/how-to-create-suggested-pr-rules/how-to-create-suggested-pr-rules-5.png" alt="" />
...
<img src="/images/Billing-Workflows/Front-Office-Payments/how-to-create-suggested-pr-rules/how-to-create-suggested-pr-rules-6.png" alt="" />

Click `Save`. Now you can view your rule in the Rules list, and edit, copy or archive it from there.

<img src="/images/Billing-Workflows/Front-Office-Payments/how-to-create-suggested-pr-rules/how-to-create-suggested-pr-rules-7.png" alt="" />
