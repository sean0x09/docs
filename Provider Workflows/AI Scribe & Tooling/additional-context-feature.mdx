...
<!-- HTML preserved: <h5> -->Location<!-- HTML preserved: </h5> -->The feature is available on the **Completed Scribe Page** after a scribe session is completed.

<!-- HTML preserved: <h5> -->How to Use<!-- HTML preserved: </h5> -->- Navigate to a completed scribe session
...
<!-- HTML preserved: <h5> -->When to Use<!-- HTML preserved: </h5> -->Use audio when you want to:
...
<!-- HTML preserved: <h5> -->Steps to Use<!-- HTML preserved: </h5> -->- **Click the “Add Context” button**
...
<!-- HTML preserved: <h5> -->Recording Controls<!-- HTML preserved: </h5> -->- **End Recording** → Saves and uploads
- **Cancel & Discard** → Stops recording without saving
<!-- HTML preserved: <h5> -->Tips For Audio Recording<!-- HTML preserved: </h5> -->- Record in a quiet environment
...
<!-- HTML preserved: <h5> -->When to Use<!-- HTML preserved: </h5> -->Use text input for:
...
<!-- HTML preserved: <h5> -->Tips For Text Input<!-- HTML preserved: </h5> -->- Be clear and concise
- Organize logically
...
<!-- HTML preserved: <h5> -->Audio Recording Issues 🎙️<!-- HTML preserved: </h5> -->- **Problem:** “Failed to start recording”
...
<!-- HTML preserved: <h5> -->Text Input Issues 💬<!-- HTML preserved: </h5> -->- **Problem:** “Add Context” button disabled
